...
public class BoardTest {
    ...
    public void testAddPieceToBoard() throws IOException {
        ...
        String loc2 = "h7";
        String loc3 = "g9";        
        instance.addPieceToBoard(loc1, Piece.createPiece(Piece.Colors.BLACK, Piece.Type.Pawn));
        instance.addPieceToBoard(loc2, Piece.createPiece(Piece.Colors.BLACK, Piece.Type.King));
        instance.addPieceToBoard(loc3, Piece.createPiece(Piece.Colors.BLACK, Piece.Type.Queen));
        instance.addPieceToBoard(loc1, Piece.createPiece(Piece.Colors.BLACK, Piece.Type.Queen));
        instance.addPieceToBoard(loc1, Piece.createPiece(Piece.Colors.BLACK, Piece.Type.Pawn));
    }
